...
<body>
    ...
    <!-- Main container -->
    <div class="container">
        <h2 class="text-center">Seed Reports from Farmers</h2>

        <!-- Form for filtering reports -->
        <div class="form-section">
            <form action="seed-reports" method="GET" class="row g-3">
                <div class="col-md-4">
                    <label for="seedName" class="form-label">Seed Name</label>
                    <input type="text" class="form-control" id="seedName" name="seedName" placeholder="Enter seed name" value="${param.seedName}">
                </div>
                <div class="col-md-4">
        ...
        <!-- Seed reports cards grid -->
        <div class="row">
            <c:forEach var="report" items="${seedReports}">
                <div class="col-md-4 mb-4">
                    <div class="card h-100">
                        <div class="card-body">
                            <h5 class="card-title">${report.seedName}</h5>
                            <p class="card-text">
